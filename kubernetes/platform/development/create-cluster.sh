...
minikube start --cpus 6 --memory 12g --driver docker --profile polar
...
echo "\n⌛ Waiting for PolarUI to be deployed..."

while [ $(kubectl get pod -l db=polar-ui | wc -l) -eq 0 ] ; do
  sleep 5
done
